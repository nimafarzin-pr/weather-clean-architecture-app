...
import '../bloc/jokebloc/joke_event.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
                onPressed: () {
                  context.read<JokeBloc>().add(const OnGetJoke());
                },
            ...
            BlocBuilder<JokeBloc, JokeState>(
              builder: (context, state) {
                ...
                } else if (state is JokeHasData) {
                  return Column(
                    key: const Key('weather_data'),
                    children: [
                      RichText(
                        text: TextSpan(
                          text: '${state.result.type} \n',
                          style: DefaultTextStyle.of(context).style,
                          children: <TextSpan>[
                            TextSpan(
                                text: '${state.result.setup} \n',
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold)),
                            TextSpan(text: '${state.result.punchline} \n'),
                          ],
                        ),
                      )
                    ],
